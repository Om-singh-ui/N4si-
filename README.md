...
<div align="center" style="background: radial-gradient(circle at top left, #0a0f14 0%, #0d1117 100%); padding: 60px; border-radius: 24px; border: 1px solid rgba(255,255,255,0.08); box-shadow: 0 0 45px rgba(0,255,240,0.08), inset 0 0 20px rgba(0,255,255,0.05); backdrop-filter: blur(15px); font-family: 'Fira Code', monospace;">

  <!-- 🪄 Medium Animated Icon -->
  <img src="https://media.giphy.com/media/26ufdipQqU2lhNA4g/giphy.gif" width="150" alt="Medium Animated Logo" style="border-radius: 50%; margin-bottom: 30px; filter: drop-shadow(0 0 20px rgba(0,255,255,0.3));"/>

  <h2 align="center" style="color:#00FFF0; font-weight:700; letter-spacing:1px; font-size:28px; margin-bottom:40px; text-shadow:0 0 15px rgba(0,255,240,0.3);">
